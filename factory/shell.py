...
#port_out.send_message([SYSEX_START, 0x77, 0x01, 0x01, 0x0F, 0x0F, 0x0F, SYSEX_END])
#port_out.send_message([SYSEX_START, 0x77, 0x02, 0x0A, 0x0C, 0x0A, 0x0B, SYSEX_END])
#port_out.send_message([SYSEX_START, 0x77, 0x03, 0x0B, 0x0A, 0x0C, 0x0A, SYSEX_END])
