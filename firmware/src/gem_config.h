...
/* Timer (TC) configuration */

#define GEM_TC_TIMER_GCLK GCLK_CLKCTRL_GEN_GCLK3
#define GEM_TC_TIMER_GCLK_DIV TC_CTRLA_PRESCALER_DIV1
#define GEM_TC_TIMER_FREQ (500000)
...
/* Square wave output strategy */
#define GEM_SQUARE_OUT_STRATEGY_PULSE 1
#define GEM_SQUARE_OUT_STRATEGY_TIMER 2
#define GEM_SQUARE_OUT_STRATEGY GEM_SQUARE_OUT_STRATEGY_PULSE
