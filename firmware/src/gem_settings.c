/*
    Hey this file was generated by Structy on 2021-01-12 20:11:48.176920 from
...
void GemSettings_init(struct GemSettings* inst) {
    ...
    inst->chorus_max_frequency = F16(0.2);
    ...
    inst->pitch_knob_nonlinearity = F16(0.33);
}
...
void GemSettings_print(const struct GemSettings* inst) {
    ...
    {
        char fix16buf[13];
        fix16_to_str(inst->chorus_max_frequency, fix16buf, 2);
        STRUCTY_PRINTF("- chorus_max_frequency: %s\n", fix16buf);
    }
    {
        char fix16buf[13];
