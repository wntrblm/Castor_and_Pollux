...
class GemSettings extends Struct {
  ...
  static _fields = [
    ...
    { name: "castor_knob_min", kind: "fix16", default: -1.02 },
    { name: "castor_knob_max", kind: "fix16", default: 1.1 },
    { name: "pollux_knob_min", kind: "fix16", default: -1.02 },
    { name: "pollux_knob_max", kind: "fix16", default: 1.1 },
