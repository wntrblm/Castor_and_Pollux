...
<form class="form" id="settings_editor">
    ...
    <div class="columns">
        <div class="column field">
            <label class="label" for="lfo_frequency">LFO frequency</label>
            <input class="input" type="range" name="lfo_frequency" value="0.2" step="0.1" min="0.1" max="5.0" data-binding-type="float" data-binding-precision="2" data-value-display="float" data-value-display-precision="1" />
            <span class="units"><span id="lfo_frequency_value_display"></span> hertz</span>
        </div>
        <div class="column">
            <p class="notification help-text">
