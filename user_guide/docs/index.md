...
Inspired by the original Juno's analog chorus circuit, Castor & Pollux contains an adaptation of chorusing that works well for a monophonic voice. Instead of applying the chorus affect *after* sound generation, Castor & Pollux's chorusing works by varying the frequency of the second oscillator using an internal low-frequency oscillator. This means that you have to [use both oscillators](#oscillator-stacking) in order to hear this effect. The chorusing knob (marked by the symbol φ) determines the amount of chorusing from none when fully counter-clockwise to its maximum at fully clockwise. The crossfader (marked by the symbol Σ) also has an impact on the intensity of the chorus.
...
* The [firmware](https://github.com/theacodes/Winterbloom_Castor_and_Pollux/tree/master/firmware) is available under the [MIT License](https://github.com/theacodes/Winterbloom-Big-Honking-Button/blob/master/firmware/LICENSE).
* The [hardware design](https://github.com/theacodes/Winterbloom_Castor_and_Pollux/tree/master/hardware) is available under the [CC BY-SA 4.0 License](https://github.com/theacodes/Winterbloom_Castor_and_Pollux/blob/master/hardware/LICENSE) and is designed using [KiCAD](https://kicad.org/) which is free and open-source. You can open the hardware files using KiCAD or you can check out a PDF of the schematics for the [mainboard](https://github.com/theacodes/Winterbloom_Castor_and_Pollux/raw/master/hardware/mainboard/mainboard.pdf) and the [jackboard](https://github.com/theacodes/Winterbloom_Castor_and_Pollux/raw/master/hardware/jackboard/jackboard.pdf).
